...
//
// int CassandraArrayStreamGetSchema(struct ArrowArrayStream*, struct ArrowSchema*);
// int CassandraArrayStreamGetNext(struct ArrowArrayStream*, struct ArrowArray*);
// const char* CassandraArrayStreamGetLastError(struct ArrowArrayStream*);
// void CassandraArrayStreamRelease(struct ArrowArrayStream*);
//
// int CassandraArrayStreamGetSchemaTrampoline(struct ArrowArrayStream*, struct ArrowSchema*);
// int CassandraArrayStreamGetNextTrampoline(struct ArrowArrayStream*, struct ArrowArray*);
//
...
var drv = cassandra.NewDriver(alloc)
...
func setErrWithDetails(err *C.struct_AdbcError, adbcError adbc.Error) {
	...
	cErrPtr := C.calloc(C.sizeof_struct_CassandraError, C.size_t(1))
	cErr := (*C.struct_CassandraError)(cErrPtr)
	cErr.message = C.CString(adbcError.Msg)
	err.message = cErr.message
	err.release = (*[0]byte)(C.CassandraReleaseErrWithDetails)
...
func initLoggingFromEnv(db adbc.DatabaseLogging) {
	...
	case "":
		return
	default:
		fmt.Fprintf(os.Stderr, "cassandra: to enable logging, set %s to 'debug', 'info', 'warn', or 'error'", logLevelEnvVar)
		return
	}
	...
	case "tempfile":
		...
		f, err := os.CreateTemp("", "adbc-cassandra.*.log")
		if err == nil {
			sink = f
		} else {
			fmt.Fprintf(os.Stderr, "[cassandra] could not open temporary log file: %v", err)
		}
	}
...
func (cStream *cArrayStream) maybeError() C.int {
	...
	if err != nil {
		if cStream.adbcErr != nil {
			C.CassandraerrRelease(cStream.adbcErr)
		} else {
...
//export CassandraArrayStreamGetLastError
func CassandraArrayStreamGetLastError(stream *C.struct_ArrowArrayStream) *C.cchar_t {
	if stream == nil || stream.release != (*[0]byte)(C.CassandraArrayStreamRelease) || stream.private_data == nil {
		return nil
	}
...
//export CassandraArrayStreamGetNext
func CassandraArrayStreamGetNext(stream *C.struct_ArrowArrayStream, array *C.struct_ArrowArray) C.int {
	if stream == nil || stream.release != (*[0]byte)(C.CassandraArrayStreamRelease) || stream.private_data == nil {
		return C.EINVAL
	}
	cStream := getFromHandle[cArrayStream](stream.private_data)
...
//export CassandraArrayStreamGetSchema
func CassandraArrayStreamGetSchema(stream *C.struct_ArrowArrayStream, schema *C.struct_ArrowSchema) C.int {
	if stream == nil || stream.release != (*[0]byte)(C.CassandraArrayStreamRelease) || stream.private_data == nil {
		return C.EINVAL
	}
	cStream := getFromHandle[cArrayStream](stream.private_data)
...
//export CassandraArrayStreamRelease
func CassandraArrayStreamRelease(stream *C.struct_ArrowArrayStream) {
	if stream == nil || stream.release != (*[0]byte)(C.CassandraArrayStreamRelease) || stream.private_data == nil {
		return
	}
...
//export CassandraErrorFromArrayStream
func CassandraErrorFromArrayStream(stream *C.struct_ArrowArrayStream, status *C.AdbcStatusCode) *C.struct_AdbcError {
	if stream == nil || stream.release != (*[0]byte)(C.CassandraArrayStreamRelease) || stream.private_data == nil {
		return nil
	}
	cStream := getFromHandle[cArrayStream](stream.private_data)
...
func exportRecordReader(rdr array.RecordReader, stream *C.struct_ArrowArrayStream) {
	...
	stream.get_last_error = (*[0]byte)(C.CassandraArrayStreamGetLastError)
	stream.get_next = (*[0]byte)(C.CassandraArrayStreamGetNextTrampoline)
	stream.get_schema = (*[0]byte)(C.CassandraArrayStreamGetSchemaTrampoline)
	stream.release = (*[0]byte)(C.CassandraArrayStreamRelease)
...
//export CassandraDatabaseGetOption
func CassandraDatabaseGetOption(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.char, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraDatabaseGetOptionBytes
func CassandraDatabaseGetOptionBytes(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.uint8_t, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraDatabaseGetOptionDouble
func CassandraDatabaseGetOptionDouble(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraDatabaseGetOptionInt
func CassandraDatabaseGetOptionInt(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraDatabaseInit
func CassandraDatabaseInit(db *C.struct_AdbcDatabase, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraDatabaseNew
func CassandraDatabaseNew(db *C.struct_AdbcDatabase, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraDatabaseRelease
func CassandraDatabaseRelease(db *C.struct_AdbcDatabase, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
			code = poison(err, "AdbcDatabaseInit", e)
		}
...
//export CassandraDatabaseSetOption
func CassandraDatabaseSetOption(db *C.struct_AdbcDatabase, key, value *C.cchar_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraDatabaseSetOptionBytes
func CassandraDatabaseSetOptionBytes(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.cuint8_t, length C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraDatabaseSetOptionDouble
func CassandraDatabaseSetOptionDouble(db *C.struct_AdbcDatabase, key *C.cchar_t, value C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraDatabaseSetOptionInt
func CassandraDatabaseSetOptionInt(db *C.struct_AdbcDatabase, key *C.cchar_t, value C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraConnectionGetOption
func CassandraConnectionGetOption(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.char, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraConnectionGetOptionBytes
func CassandraConnectionGetOptionBytes(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.uint8_t, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraConnectionGetOptionDouble
func CassandraConnectionGetOptionDouble(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraConnectionGetOptionInt
func CassandraConnectionGetOptionInt(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraConnectionNew
func CassandraConnectionNew(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraConnectionSetOption
func CassandraConnectionSetOption(cnxn *C.struct_AdbcConnection, key, val *C.cchar_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraConnectionSetOptionBytes
func CassandraConnectionSetOptionBytes(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.cuint8_t, length C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraConnectionSetOptionDouble
func CassandraConnectionSetOptionDouble(db *C.struct_AdbcConnection, key *C.cchar_t, value C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraConnectionSetOptionInt
func CassandraConnectionSetOptionInt(db *C.struct_AdbcConnection, key *C.cchar_t, value C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraConnectionInit
func CassandraConnectionInit(cnxn *C.struct_AdbcConnection, db *C.struct_AdbcDatabase, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraConnectionRelease
func CassandraConnectionRelease(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraConnectionCancel
func CassandraConnectionCancel(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraConnectionGetInfo
func CassandraConnectionGetInfo(cnxn *C.struct_AdbcConnection, codes *C.cuint32_t, len C.size_t, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraConnectionGetObjects
func CassandraConnectionGetObjects(cnxn *C.struct_AdbcConnection, depth C.int, catalog, dbSchema, tableName *C.cchar_t, tableType **C.cchar_t, columnName *C.cchar_t,
...
//export CassandraConnectionGetStatistics
func CassandraConnectionGetStatistics(cnxn *C.struct_AdbcConnection, catalog, dbSchema, tableName *C.cchar_t, approximate C.char, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraConnectionGetStatisticNames
func CassandraConnectionGetStatisticNames(cnxn *C.struct_AdbcConnection, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
			code = poison(err, "AdbcConnectionGetStatistics", e)
		}
...
//export CassandraConnectionGetTableSchema
func CassandraConnectionGetTableSchema(cnxn *C.struct_AdbcConnection, catalog, dbSchema, tableName *C.cchar_t, schema *C.struct_ArrowSchema, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraConnectionGetTableTypes
func CassandraConnectionGetTableTypes(cnxn *C.struct_AdbcConnection, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraConnectionReadPartition
func CassandraConnectionReadPartition(cnxn *C.struct_AdbcConnection, serialized *C.cuint8_t, serializedLen C.size_t, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraConnectionCommit
func CassandraConnectionCommit(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
func CassandraConnectionRollback(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraStatementGetOption
func CassandraStatementGetOption(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.char, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraStatementGetOptionBytes
func CassandraStatementGetOptionBytes(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.uint8_t, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraStatementGetOptionDouble
func CassandraStatementGetOptionDouble(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraStatementGetOptionInt
func CassandraStatementGetOptionInt(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraStatementNew
func CassandraStatementNew(cnxn *C.struct_AdbcConnection, stmt *C.struct_AdbcStatement, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraStatementRelease
func CassandraStatementRelease(stmt *C.struct_AdbcStatement, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
func CassandraStatementCancel(stmt *C.struct_AdbcStatement, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraStatementPrepare
func CassandraStatementPrepare(stmt *C.struct_AdbcStatement, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
func CassandraStatementExecuteQuery(stmt *C.struct_AdbcStatement, out *C.struct_ArrowArrayStream, affected *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraStatementExecuteSchema
func CassandraStatementExecuteSchema(stmt *C.struct_AdbcStatement, schema *C.struct_ArrowSchema, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
			code = poison(err, "AdbcStatementExecuteQuery", e)
		}
...
//export CassandraStatementSetSqlQuery
func CassandraStatementSetSqlQuery(stmt *C.struct_AdbcStatement, query *C.cchar_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraStatementSetSubstraitPlan
func CassandraStatementSetSubstraitPlan(stmt *C.struct_AdbcStatement, plan *C.cuint8_t, length C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraStatementBind
func CassandraStatementBind(stmt *C.struct_AdbcStatement, values *C.struct_ArrowArray, schema *C.struct_ArrowSchema, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraStatementBindStream
func CassandraStatementBindStream(stmt *C.struct_AdbcStatement, stream *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraStatementGetParameterSchema
func CassandraStatementGetParameterSchema(stmt *C.struct_AdbcStatement, schema *C.struct_ArrowSchema, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraStatementSetOption
func CassandraStatementSetOption(stmt *C.struct_AdbcStatement, key, value *C.cchar_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraStatementSetOptionBytes
func CassandraStatementSetOptionBytes(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.cuint8_t, length C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraStatementSetOptionDouble
func CassandraStatementSetOptionDouble(db *C.struct_AdbcStatement, key *C.cchar_t, value C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraStatementSetOptionInt
func CassandraStatementSetOptionInt(db *C.struct_AdbcStatement, key *C.cchar_t, value C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export CassandraStatementExecutePartitions
func CassandraStatementExecutePartitions(stmt *C.struct_AdbcStatement, schema *C.struct_ArrowSchema, partitions *C.struct_AdbcPartitions, affected *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export AdbcDriverCassandraInit
func AdbcDriverCassandraInit(version C.int, rawDriver *C.void, err *C.struct_AdbcError) C.AdbcStatusCode {
	...
	driver.DatabaseInit = (*[0]byte)(C.CassandraDatabaseInit)
	driver.DatabaseNew = (*[0]byte)(C.CassandraDatabaseNew)
	driver.DatabaseRelease = (*[0]byte)(C.CassandraDatabaseRelease)
	driver.DatabaseSetOption = (*[0]byte)(C.CassandraDatabaseSetOption)

	driver.ConnectionNew = (*[0]byte)(C.CassandraConnectionNew)
	driver.ConnectionInit = (*[0]byte)(C.CassandraConnectionInit)
	driver.ConnectionRelease = (*[0]byte)(C.CassandraConnectionRelease)
	driver.ConnectionSetOption = (*[0]byte)(C.CassandraConnectionSetOption)
	driver.ConnectionGetInfo = (*[0]byte)(C.CassandraConnectionGetInfo)
	driver.ConnectionGetObjects = (*[0]byte)(C.CassandraConnectionGetObjects)
	driver.ConnectionGetTableSchema = (*[0]byte)(C.CassandraConnectionGetTableSchema)
	driver.ConnectionGetTableTypes = (*[0]byte)(C.CassandraConnectionGetTableTypes)
	driver.ConnectionReadPartition = (*[0]byte)(C.CassandraConnectionReadPartition)
	driver.ConnectionCommit = (*[0]byte)(C.CassandraConnectionCommit)
	driver.ConnectionRollback = (*[0]byte)(C.CassandraConnectionRollback)

	driver.StatementNew = (*[0]byte)(C.CassandraStatementNew)
	driver.StatementRelease = (*[0]byte)(C.CassandraStatementRelease)
	driver.StatementSetOption = (*[0]byte)(C.CassandraStatementSetOption)
	driver.StatementSetSqlQuery = (*[0]byte)(C.CassandraStatementSetSqlQuery)
	driver.StatementSetSubstraitPlan = (*[0]byte)(C.CassandraStatementSetSubstraitPlan)
	driver.StatementBind = (*[0]byte)(C.CassandraStatementBind)
	driver.StatementBindStream = (*[0]byte)(C.CassandraStatementBindStream)
	driver.StatementExecuteQuery = (*[0]byte)(C.CassandraStatementExecuteQuery)
	driver.StatementExecutePartitions = (*[0]byte)(C.CassandraStatementExecutePartitions)
	driver.StatementGetParameterSchema = (*[0]byte)(C.CassandraStatementGetParameterSchema)
	driver.StatementPrepare = (*[0]byte)(C.CassandraStatementPrepare)

	if version == C.ADBC_VERSION_1_1_0 {
		driver.ErrorGetDetailCount = (*[0]byte)(C.CassandraErrorGetDetailCount)
		driver.ErrorGetDetail = (*[0]byte)(C.CassandraErrorGetDetail)
		driver.ErrorFromArrayStream = (*[0]byte)(C.CassandraErrorFromArrayStream)

		driver.DatabaseGetOption = (*[0]byte)(C.CassandraDatabaseGetOption)
		driver.DatabaseGetOptionBytes = (*[0]byte)(C.CassandraDatabaseGetOptionBytes)
		driver.DatabaseGetOptionDouble = (*[0]byte)(C.CassandraDatabaseGetOptionDouble)
		driver.DatabaseGetOptionInt = (*[0]byte)(C.CassandraDatabaseGetOptionInt)
		driver.DatabaseSetOptionBytes = (*[0]byte)(C.CassandraDatabaseSetOptionBytes)
		driver.DatabaseSetOptionDouble = (*[0]byte)(C.CassandraDatabaseSetOptionDouble)
		driver.DatabaseSetOptionInt = (*[0]byte)(C.CassandraDatabaseSetOptionInt)

		driver.ConnectionCancel = (*[0]byte)(C.CassandraConnectionCancel)
		driver.ConnectionGetOption = (*[0]byte)(C.CassandraConnectionGetOption)
		driver.ConnectionGetOptionBytes = (*[0]byte)(C.CassandraConnectionGetOptionBytes)
		driver.ConnectionGetOptionDouble = (*[0]byte)(C.CassandraConnectionGetOptionDouble)
		driver.ConnectionGetOptionInt = (*[0]byte)(C.CassandraConnectionGetOptionInt)
		driver.ConnectionGetStatistics = (*[0]byte)(C.CassandraConnectionGetStatistics)
		driver.ConnectionGetStatisticNames = (*[0]byte)(C.CassandraConnectionGetStatisticNames)
		driver.ConnectionSetOptionBytes = (*[0]byte)(C.CassandraConnectionSetOptionBytes)
		driver.ConnectionSetOptionDouble = (*[0]byte)(C.CassandraConnectionSetOptionDouble)
		driver.ConnectionSetOptionInt = (*[0]byte)(C.CassandraConnectionSetOptionInt)

		driver.StatementCancel = (*[0]byte)(C.CassandraStatementCancel)
		driver.StatementExecuteSchema = (*[0]byte)(C.CassandraStatementExecuteSchema)
		driver.StatementGetOption = (*[0]byte)(C.CassandraStatementGetOption)
		driver.StatementGetOptionBytes = (*[0]byte)(C.CassandraStatementGetOptionBytes)
		driver.StatementGetOptionDouble = (*[0]byte)(C.CassandraStatementGetOptionDouble)
		driver.StatementGetOptionInt = (*[0]byte)(C.CassandraStatementGetOptionInt)
		driver.StatementSetOptionBytes = (*[0]byte)(C.CassandraStatementSetOptionBytes)
		driver.StatementSetOptionDouble = (*[0]byte)(C.CassandraStatementSetOptionDouble)
		driver.StatementSetOptionInt = (*[0]byte)(C.CassandraStatementSetOptionInt)
	}
